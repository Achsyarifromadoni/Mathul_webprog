...
}else{$query_simpan = mysqli_query($koneksidb, "INSERT INTO mst_pegawai(nama_peg, divisi, jabatan, tgl_masuk, status, alamat, jk, foto) values 
('".$nama."', '".$jabatan."', '".$divisi."','".$tanggsal."','".$alamat."','".$status."','".$tanggsal."','".$ceknamafile."')")
