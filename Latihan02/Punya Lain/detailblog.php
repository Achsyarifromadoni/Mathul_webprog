    ...
    <section id="blog" class="bg-white">
      <div class="container d-flex flex-column align-items-center p-4">
        ...
        <div class="row mb-4">
          ...
          <?php
          $query = mysqli_query($koneksidb, "select * from mst_blog where idblog=".$_GET['id']."")or die(mysqli_error($koneksidb));
          ...
          ?>
            ...
            <img src="assets/images/<?= $data['gambar'];?>" width="500" class="img-thumbnail img-fluid mx-auto d-block" />
