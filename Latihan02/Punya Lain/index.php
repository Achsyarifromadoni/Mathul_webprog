    ...
    <section id="blog" class="bg-white">
      <div class="container-fluid d-flex flex-column align-items-center p-4">
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-2">
            <img src="assets/images/<?=$row['gambar']?>" width="270" class="img-fluid img-thumbnail" />
          </div>
          <div class="col-md-6">
            <h4><?php echo $row['judul'];?></h4>
            <div>
              <span class="badge bg-info text-white rounded-3 fs-6"><?php echo $row['tglblog'];?></span>
              <span class="text-primary fs-6">Create By :<?php echo $row['penulis'];?></span>
            </div>
            <span class="text-primary fs-6"><?= substr_replace($row['isiblog'],'...',100)?></span>
            <p>
              [ <a href="detailblog.php?id=<?= $row['idblog']?>">-Baca Selengkapnya</a> ]
            </p>
            <hr />
          </div>
          <?php
